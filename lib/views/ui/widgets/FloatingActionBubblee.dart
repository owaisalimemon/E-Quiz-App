...
class FloatingActionBubblee extends AnimatedWidget {
  const FloatingActionBubblee({
    Key? key,
    required this.items,
...
class BubbleMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
          height: 50.w, width: 50.w, child: Image.asset('assets/icons/VS.png')),
    );
  }
}
